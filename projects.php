    ...
    <div class="inner-pg-banner project-pg-banner">
        <div class="container">
            <div class="inner-pg-breadcrumb">
                ...
                <div>
                    <a href="index.html" class="hp-lnk">Projects</a>
        ...
        <div class="container">
            <div class="row mb-md-5 mb-2">
                <div class="col-lg-10 col-md-8 col-9">
                    <div class="projects-pg-caption">
                        <h2>Constructing excellence, <br> every step of the way</h2>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-3 px-md-5 px-2">
